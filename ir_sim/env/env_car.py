...
class env_car:
    def __init__(self, robot_class=car_robot, car_num=1, step_time=0.1, **kwargs):
        ...
        for j in range(self.car_num):
            car = car_robot(id=j, shape=car_shape_list[j], init_state=car_state_list[j], goal=car_goal_list[j], step_time=self.step_time, **kwargs)
